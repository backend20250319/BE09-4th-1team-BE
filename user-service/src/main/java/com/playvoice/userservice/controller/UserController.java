...
public class UserController {
    ...
    public ResponseEntity<?> changeName(@RequestBody ChangeNameRequest request, Principal principal) {
        String username = principal.getName();
    ...
    public ResponseEntity<Void> changePassword(@RequestBody ChangePasswordRequest request, @AuthenticationPrincipal String userId) {
        userService.changePassword(Long.valueOf(userId), request.getOldPassword(), request.getNewPassword());
        return ResponseEntity.ok().build();
    }

    @PutMapping("/me/email")
    public ResponseEntity<Void> changeEmail(@RequestBody ChangeEmailRequest request, @AuthenticationPrincipal String userId) {
        userService.changeEmail(Long.valueOf(userId), request.getPassword(), request.getNewEmail());
        return ResponseEntity.ok().build();
    }

    @PutMapping("/me/name")
    public ResponseEntity<Void> changeName(@RequestBody ChangeNameRequest request, @AuthenticationPrincipal String userId) {
